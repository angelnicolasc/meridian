...
- [ADR-0001: Dual-queue vs. priority weights](adr/0001-dual-queue-rationale.md)
- [ADR-0002: Workspace tri-crate layout](adr/0002-workspace-tri-crate.md)
- [ADR-0003: DashMap for per-request state](adr/0003-dashmap-rationale.md)
- [ADR-0004: KV tier promotion policy](adr/0004-kv-tier-promotion-policy.md)
